...
public class RefillControllerTest {
	...
	@Test
	public void getRefillDuesAsOfDateTest() throws InvalidTokenException, ParseException {
		ResponseEntity<List<RefillOrderLine>> list = refillController.getRefillDuesAsOfDate("token", 1, "CR7");
