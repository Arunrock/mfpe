 ...
 class SubscriptionServiceImplTest {
	...
	@Test
	 void unsubscribe() {
		...
		//subscriptionServiceImplementation.unsubscribe("member", (long) 45, "token");
	...
	@Test
	 void unsubscribefalse() {
		...
		//when(subscriptionServiceImplementation.unsubscribe("asd", (long) 45, "token")).thenReturn(new ResponseEntity<String>("Not a member",HttpStatus.OK));
