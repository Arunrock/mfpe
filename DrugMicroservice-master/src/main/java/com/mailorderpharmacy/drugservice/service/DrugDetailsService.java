...
public interface DrugDetailsService
{
    ...
    DrugDetails getDispatchableDrugStock(final String id, final String location, final String token) throws InvalidTokenException, StockNotFoundException, DrugNotFoundException;
	...
	ResponseEntity<SuccessResponse> AddupdateQuantity(String drugName, String location, int quantity, String token)
