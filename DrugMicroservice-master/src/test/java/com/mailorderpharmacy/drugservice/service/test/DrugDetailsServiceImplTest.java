...
class DrugDetailsServiceImplTest {
	...
	void getDispatchableDrugStockSuccess() throws DrugNotFoundException, InvalidTokenException, StockNotFoundException {
		...
		final DrugDetails actual = this.drugDetailsServiceImpl.getDispatchableDrugStock("D5", "salem", "token");
		final String actualValue = String.valueOf(actual.getDrugId()) + " " + actual.getDrugName() + " "
					+ actual.getExpiryDate() + " " + actual.getManufacturer() +" " + actual.getDruglocationQuantities()+" "+actual.getManufactureDate() ;
		final String ExpectedValue = String.valueOf(drugDetails.getDrugId()) + " " + drugDetails.getDrugName() + " "
				+ drugDetails.getExpiryDate() + " " +drugDetails.getManufacturer()+" "+drugDetails.getDruglocationQuantities() +" " +drugDetails.getManufactureDate();
